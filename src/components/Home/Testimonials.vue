    ...
    <div class="container">
      <div class="row">
        <div class="text-center pb-4">
          <p class="text-white">OPINIONES</p>
          <h2 class="py-2 text-white">Nuestros estudiantes opinan</h2>
